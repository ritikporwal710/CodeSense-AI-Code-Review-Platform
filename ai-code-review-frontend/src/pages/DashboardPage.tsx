  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-card/60 backdrop-blur border border-border/50 rounded-2xl p-6 shadow-sm shadow-black/20">
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center bg-card/40 rounded-3xl border border-white/5 border-dashed">
            ...
            <Link
              ...
              className="px-5 py-2.5 rounded-xl text-sm font-semibold text-white
                ...
                shadow-lg shadow-violet-500/25 active:scale-95"
            >
              ...
              return (
                <Link
                  ...
                  className="group flex items-center gap-4 bg-card/60 backdrop-blur border border-border/50
                    rounded-2xl p-5 hover:border-violet-500/40 hover:bg-card/80 transition-all active:scale-[0.99] shadow-sm"
                >
                  {/* Score badge */}
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                      {review.status === "completed" ? (
                        <span className="flex items-center gap-1 text-green-400/90 font-medium">
                          <CheckCircle2 className="w-3.5 h-3.5" /> Completed
                        </span>
                      ) : review.status === "pending" ? (
                        <span className="flex items-center gap-1 text-yellow-400/90 font-medium">
                  ...
                  <ChevronRight className="w-5 h-5 text-muted-foreground group-hover:text-violet-400 transition-colors flex-shrink-0 group-hover:translate-x-1 transition-transform" />
                </Link>
              );
            })}
          </div>
